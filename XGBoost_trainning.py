...
log_filename = os.path.join(log_dir, f"train_log_XGBoost_{now}_{rand_str}.txt")
...
# 5. 构建和训练模型
model = xgb.XGBClassifier(objective='multi:softprob', num_class=len(label_encoder.classes_), n_estimators=500, random_state=42, tree_method='auto')

...
log_filename = os.path.join(log_dir, f"train_log_CatBoost_{now}_{rand_str}.txt")
...
# 5. 构建和训练模型
model = CatBoostClassifier(loss_function='MultiClass', iterations=500, random_seed=42, verbose=False)
